...
injury_severity <- data.frame(
  InjSevName = c(
    "Injury Severity Unknown", "No apparent injury", "Possible Injury", "Suspected Minor Injury","Suspected Serious Injury","Fatality"
  ), 
  InjSevName_es = c(
    "Gravedad de la herida desconocida", "Sin herida aparente", "Posible herida", "Sospecha de herida menor", "Sospecha de herida grave", "Fatalidad"
  ),
  code = c(NA, "O", "C", "B", "A", "K"),
